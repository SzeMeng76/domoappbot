...
class BotConfig:
    ...
    whitelist_db_path: str = "whitelist.db"
    admin_db_path: str = "admin_data.db"
...
class ConfigManager:
    ...
    def _load_from_environment(self):
        ...
        # 数据库配置
        self.config.db_path = os.getenv('DB_PATH', 'bot_data.db')
        self.config.whitelist_db_path = os.getenv('WHITELIST_DB_PATH', 'whitelist.db')
        self.config.admin_db_path = os.getenv('ADMIN_DB_PATH', 'admin_data.db')
